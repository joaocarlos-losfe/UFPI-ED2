...
AVLNode avlRotateLeftToRight(AVLNode node); // rotacao da esquerda para a direita
AVLNode avlRotateRightToLeft(AVLNode node); // rotacao da direita para a esquerda

AVLNode avlInsert(AVLNode root_node, char *key); //insere um nó a arvore
AVLNode avlSeach(AVLNode root_node, char *key); // procura um elemento da arvore e retorna o seu nó
