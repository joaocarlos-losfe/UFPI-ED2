...
char * largerString(Data data_header, char *str);
int numberStartingVowel(Data data_head_of_list, int count);
void newVectorStrings(Data data_head_of_list, List empty_filtred_list);
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            strcpy(temp_data->str_value, str);
        ...
        case 2:
            strcpy(temp_str, "");
            temp_str = largerString(strings->head, temp_str);
...
char * largerString(Data data_header, char *str)
{
    if(data_header != NULL)
    {
        ...
        str = largerString(data_header, str);
    }
...
int numberStartingVowel(Data data_head_of_list, int count)
{
    if (data_head_of_list != NULL)
    {
        ...
        if(isVogal(data_head_of_list->str_value) == true)
        {
            count += 1;
        }
        ...
        count = numberStartingVowel(data_head_of_list, count);
    }
...
void newVectorStrings(Data data_head_of_list, List empty_filtred_list)
{
    if(data_head_of_list!=NULL)
    {
        ...
        if(strlen(data_head_of_list->str_value) > 4 && data_head_of_list->str_value[0] >=65 && data_head_of_list->str_value[0] <=90)
        {
            ...
            listAppend(empty_filtred_list, temp_data);
        }
        
        data_head_of_list = data_head_of_list->next;

        newVectorStrings(data_head_of_list, empty_filtred_list);
    }
